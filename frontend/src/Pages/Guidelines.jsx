...
const Guidelines = () => {
  ...
  return (
    <div className="relative w-full h-full bg-black custom-bg-small">
      <div className="bg-black min-h-screen text-white py-10 px-4 md:px-8 lg:px-16">
        <div className="flex justify-center items-center text-center">
          <p className="text-[28px] sm:text-[32px] md:text-[40px] lg:text-[50px] font-exo font-bold text-[#d88a4c]">
            Event Guidelines
          </p>
        </div>
        ...
        <div className="flex justify-center mt-8">
          <div className="bg-[#212529] w-full max-w-7xl rounded-[25px] p-6">
            <h3 className="my-3 text-[#d88a4c] text-lg sm:text-xl md:text-2xl font-bold">Rules</h3>
            <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base md:text-lg">
              <li>The VCET Hackathon will take place on <span className="text-[#d88a4c]">6th and 7th October 2023.</span></li>
              ...
              <li>Entry fee is <span className="text-[#d88a4c]">₹500</span> per head (Includes 3 meals, breakfasts, snacks, and sleeping accommodation).</li>
              <li>Participants are free to use open standard repositories, APIs, and publicly available libraries.</li>
              <li>Progress of the project will be tracked during the Hackathon. <span className="text-[#d88a4c]">Use of readymade or precompiled code will lead to disqualification.</span></li>
            ...
            <div className="mt-4">
              <button
                className="border border-white text-white py-2 px-4 rounded hover:bg-[#d88a4c] hover:border-[#d88a4c] transition"
            ...
            <ul className="list-disc pl-5 space-y-2 mt-4 text-sm sm:text-base md:text-lg">
              ...
              <li>Last date for submission of abstract is <span className="text-[#d88a4c]">September 27, 2023</span>.</li>
              <li>The selected teams will get a confirmation after <span className="text-[#d88a4c]">September 28, 2023</span>.</li>
              <li>Payment for the selected teams i.e. ₹500 per head should be made by <span className="text-[#d88a4c]">October 1, 2023</span>. Entry fee payment of the entire team should be done in a single transaction.</li>
              <li>Out of the 5 abstracts submitted, the final Problem Statement for your team will be disclosed on <span className="text-[#d88a4c]">October 5, 2023.</span></li>
          ...
          <div className="fixed inset-0 bg-gray-800 bg-opacity-70 flex items-center justify-center z-50">
            <div className="bg-[#212529] p-6 rounded-lg w-full max-w-md">
              ...
              <form className="space-y-4">
                ...
                <div>
                  <label htmlFor="team" className="block text-sm font-medium text-white">Team Members</label>
                  <textarea
                    id="team"
                    rows="3"
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                ...
                <button
                  type="submit"
                  className="w-full bg-[#d88a4c] text-white py-2 px-4 rounded-md hover:bg-[#c97a39]"
                >
                  Submit
                </button>
              </form>
