        ...
        <div className="flex justify-center tracking-tight sectionMargin">
          <div className="bg-[#212529] w-full max-w-7xl rounded-2xl p-6">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-4 text-sm sm:text-base md:text-lg">
              ...
              <li>Last date for submission of abstract is <span className="text-customOrange">September 2, 2024</span>.</li>
              <li>The selected teams will get a confirmation after <span className="text-customOrange">September 25, 2024</span>.</li>
              <li>Payment for the selected teams i.e. ₹500 per head should be made by <span className="text-customOrange">September 29, 2024</span>. Entry fee payment of the entire team should be done in a single transaction.</li>
