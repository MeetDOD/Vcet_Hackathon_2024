        ...
        <>
            <div style={{backgroundColor: "black"}}>
                ...
                <div>
                    ...
                    <form className="form-main-container marginal mt-5" 
                    onSubmit={(e) => handleFormSubmit(e, usersToAdd, teamName, setSubmitText, setSubmitting, setUsersToAdd, setTeamName, toast)}>
                                ...
                                <div className=" form-grid">
                                    <div className="mx-5">
                                        <div className=" form-grid-note">
                                            <label className="form-heading text-center" htmlFor="id_team_name">
                                                Note
                                            </label>
                            ...
                            <div className="team-leader-container">
                                <div className="details-container form-grid">
                                    ...
                                    <input type="text" className="form-control  half-form tel-input" list={`degree5`} pattern="^[A-Za-z.]+( [A-Za-z.]+)*$"
                                        name="team_leader_tel_number" value={usersToAdd[0]?.degree || ''} onChange={(e) => handleUserChange(0, 'degree', e.target.value)} placeholder="Degree" data-error="Please enter your team name"
                                    />
                                    <datalist id={`degree5`}>
                                ...
                                <div key={index} className={`team-member${_}-container`}>
                                    <div className="details-container form-grid">
                                        ...
                                        <input type="text" pattern="[A-Za-z]+" className="form-control" id="id_team_leader_name" name="to_name"
                                            placeholder="First Name" value={usersToAdd[_]?.fname || ''} onInput={(e) => handleUserChange(_, 'fname', e.target.value)} required={checkIfAnyFieldIsFilled(_)} data-error="Please enter your First name" />
                                        <input type="text" pattern="[A-Za-z]+" className="form-control" id="id_team_leader_name" name="to_name"
                                            required={checkIfAnyFieldIsFilled(_)} placeholder="Last Name" value={usersToAdd[_]?.lname || ''} onInput={(e) => handleUserChange(_, 'lname', e.target.value)} data-error="Please enter your Last name" />


                                        {/* Member Email */}
                                        <input type="email" className="form-control email-input" id="id_team_leader_email" name="to_email"
                                            required={checkIfAnyFieldIsFilled(_)} placeholder="Email" value={usersToAdd[_]?.email || ''} onInput={(e) => handleUserChange(_, 'email', e.target.value)} data-error="Please enter your Email" />



                                        {/* Member Phone */}
                                        <input type="number" maxLength="10" pattern="^[6-9]\d{9}$" className="form-control half-form tel-input" id="id_team_leader_tel_number"
                                            required={checkIfAnyFieldIsFilled(_)} name="team_leader_tel_number" value={usersToAdd[_]?.phoneNo || ''} onInput={(e) => handleUserChange(_, 'phoneNo', e.target.value)} placeholder="Phone Number" data-error="Please enter your Phone Number"
                                        />

                                        <select className="form-control half-form"
                                            value={usersToAdd[_]?.gender || ''} onInput={(e) => handleUserChange(_, 'gender', e.target.value)}
                                        ...
                                        <input type="text" pattern="^[A-Za-z]+( [A-Za-z]+)*$" className="form-control" id="id_team_leader_college_name" name="team_leader_college_name"
                                            required={checkIfAnyFieldIsFilled(_)} placeholder="College Name" value={usersToAdd[_]?.college || ''} onInput={(e) => handleUserChange(_, 'college', e.target.value)} data-error="Please enter your College name" />

                                        {/* Member Degree, Dept., Year */}
                                        <input type="text" className="form-control half-form" list={`degree${index}`}
                                            required={checkIfAnyFieldIsFilled(_)} name="team_leader_tel_number" pattern="^[A-Za-z.]+( [A-Za-z.]+)*$" value={usersToAdd[_]?.degree || ''} onInput={(e) => handleUserChange(_, 'degree', e.target.value)} placeholder="Degree" data-error="Please enter your Degree"
                                        />
                                        ...
                                        <select className="form-control half-form"
                                            value={usersToAdd[_]?.year || ''} onChange={(e) => handleUserChange(_, 'year', e.target.value)}
                                            name="team_leader_gender" id="id_team_leader_gender">
                                            <option className="form-control" disabled hidden value="">Year</option>
                                            <option className="form-control" value="FE">First Year</option>
                                            <option className="form-control" value="SE">Second Year</option>
                                        ...
                                        <input type="text" list={`browsers${index}`} pattern='^[A-Za-z\s]+$' className="form-control half-form" id="id_team_leader_college_name" name="team_leader_college_name"
                                            required={checkIfAnyFieldIsFilled(_)} placeholder="Department" value={usersToAdd[_]?.dept || ''} onInput={(e) => handleUserChange(_, 'dept', e.target.value)} data-error="Please enter your Department name" />
                                        ...
                                        <input type="number" maxLength="6" pattern="[0-9]{6}" className="form-control half-form tel-input" id="id_team_leader_tel_number"
                                            required={checkIfAnyFieldIsFilled(_)} name="team_leader_tel_number" value={usersToAdd[_]?.pincode || ''} onInput={(e) => handleUserChange(_, 'pincode', e.target.value)} placeholder="Pin Code" data-error="Please enter your Pincode number"
                                        />
                        ...
                        <div style={{ textAlign: 'center' }}>
                            <button disabled={submitting} className={`btn btn-brand text-light px-5 my-5`} style={{ fontSize: "20px", backgroundColor: "green" }} type="submit">
                                <span className={`d-flex justify-content-center align-items-center `}>
                                    {submitText} &nbsp;
                                    <span style={{ display: submitting ? "" : "none" }} className="loader">
